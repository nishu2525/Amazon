...
function Signup() {
  return (
    ...
    <div className='w-full bg-gray-100 h-screen '>
      ...
      <Link to='/' className='cursor-pointer'><img className='w-32 ml-28 pt-6' src="https://logos-world.net/wp-content/uploads/2020/04/Amazon-Logo.png" alt="" /></Link>
        <div className='w-full border border-zinc-200 p-6 '>
          <h2 className='font-titleFont text-3xl font-medium md-4 '>Sign up</h2>
          <div>
            <div className='pt-4 flex flex-col gap-2'>
          <label>Name</label>
          <input type="text" placeholder='Your Full Name' className='p-1 pl-2 mb-2' />
          <label>Email </label>
          <input type="email" placeholder='Email' className='p-1 pl-2 mb-2' />
          <label>Phone number</label>
          <input type="number" placeholder='Your Phone Number' className='p-1 pl-2 mb-2' />
          <label>Password</label>
          <input type="password" placeholder='Set Password 6 atleast characters ' className='p-1 pl-2 mb-2' />
            </div>
        ...
        <Link to= '/signin' ><button className='w-full py-1.5 rounded-md mt-3 font-titleFont font-medium text-base bg-gray-200 border border-white-200 hover:border-yellow-700duration-200'>Login </button></Link>
      </form>
    </div>
    </div>
  )
